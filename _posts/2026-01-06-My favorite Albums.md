...
<p>The header image features my top three favorite albums: Shangri-La (心中的日月) by Wang Leehom, Dangerous World (危险世界) by Khalil Fong, and David Tao’s self-titled debut album (陶喆同名专辑).</p>
...
<div class="post_img_video">
    <img src="{{ site.baseurl }}/img/post/my_favorite_albums/image.jpg" alt="Wang Leehom Music Salon"/>
    <figcaption>Wang Leehom Music Salon</figcaption>
</div>
